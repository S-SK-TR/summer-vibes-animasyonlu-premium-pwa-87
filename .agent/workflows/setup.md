...
- `CLAUDE.md` dosyasındaki `Summer Vibes - Animasyonlu Premium PWA`, `Summer Vibes - Animasyonlu Premium PWA — Premium SaaS Uygulaması`, `[TECH_STACK]` gibi alanları gerçek değerlerle değiştir
